  ...
  describe(`GET /api/sitems`, () => {
    context(`Given no items`, () => {
      it(`Responds with 200 and an empty item`, () => {
        return supertest(app).get(`/api/sitems`).expect(200, []);
      });
    });
    context(`Given there are items in the database`, () => {
      ...
      it(`GET /api/sitems responds with 200 and all of the items`, () => {
        return supertest(app).get(`/api/sitems`).expect(200, testItems);
        /*.then(res => {
    ...
    context(`Given there are items in the database`, () => {
      ...
      it(`Responds with 204 and removes the item`, () => {
        ...
        return supertest(app)
          ...
          .expect(204)
          .then((res) =>
            supertest(app).get(`/api/sitems`).expect(expectedItem)
          );
      });
    });
  });
